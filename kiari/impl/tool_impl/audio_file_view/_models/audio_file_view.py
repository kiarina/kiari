...
from .._i18n import AudioFileViewI18n
from .._schemas.audio_file_view_schema import AudioFileViewSchema
...
async def AudioFileView(
    ...
    t = get_i18n(AudioFileViewI18n, ctx.run_context.language)
    ...
    if file_info.type != "audio":
        return Content(text=t.not_audio_error.format(uri_or_file_path=uri_or_file_path))
