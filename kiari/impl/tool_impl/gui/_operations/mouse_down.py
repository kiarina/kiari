...
async def mouse_down(ctx: ToolContext, args: GuiSchema) -> str:
    ...
    gui.mouse.down(args.button)

    await asyncio.sleep(2.0)

    action_name = t.left_button_press if args.button == "left" else t.right_button_press

    return t.mouse_down_result.format(action_name=action_name)
